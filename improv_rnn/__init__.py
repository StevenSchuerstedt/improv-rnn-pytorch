...
def generate_sequnce(encoder, model, backing_chords = 'C G Am F C G F C', primer_melody = [60], steps_per_chord = 48, qpm = 120, steps_per_quarter = 12, render_chords=True):
